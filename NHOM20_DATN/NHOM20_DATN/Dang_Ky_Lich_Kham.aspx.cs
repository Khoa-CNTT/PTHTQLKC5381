    ...
    public partial class Dang_Ky_Lich_Kham : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack) // Chỉ tải thông tin bác sĩ khi lần đầu tiên tải trang
            {
                ...
                {
                    Response.Redirect("DangNhap.aspx"); // Nếu chưa đăng nhập, chuyển hướng về trang đăng nhập
                }
            }
        }
        private void LoadDoctorData(string doctorID)
        {
            ...
            string sql = "SELECT HoTen, Email,SoDienThoai,DiaChiPhongKham FROM BacSi WHERE IDBacSi = @DoctorID";
