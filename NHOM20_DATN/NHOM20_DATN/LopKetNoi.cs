...
namespace NHOM20_DATN
{
    public class LopKetNoi
    {
        ...
        private void ketnoi()
        {
            string sqlCon = @"Data Source=laptop-12s0uk54;Initial Catalog=TESTDATAKLTN;Integrated Security=True;Connect Timeout=30;Encrypt=True;TrustServerCertificate=True";
