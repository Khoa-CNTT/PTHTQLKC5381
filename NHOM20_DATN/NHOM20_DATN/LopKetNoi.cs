...
namespace NHOM20_DATN
{
    public class LopKetNoi
    {
        ...
        private void ketnoi()
        {
            string sqlCon = @"Data Source=DESKTOP-PPT3FPB;Initial Catalog=QUANLYKHAMBENH;Integrated Security=True;Connect Timeout=30;Encrypt=True;TrustServerCertificate=True;";
