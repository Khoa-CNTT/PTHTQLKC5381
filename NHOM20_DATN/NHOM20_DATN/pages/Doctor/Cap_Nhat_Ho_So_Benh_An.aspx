            ...
            <asp:GridView ID="gridMedicalRecord" runat="server" AutoGenerateColumns="False" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Ngày Cập Nhật">
                        <ItemTemplate>
                            <asp:Label ID="lbl_NgayCapNhat" title='<%#(DateTime.Parse(Eval("NgayCapNhat").ToString())).ToString("dd/MM/yyyy")  %>' runat="server" Text='<%#(DateTime.Parse(Eval("NgayCapNhat").ToString())).ToString("dd/MM/yyyy")  %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%-- ==============     Ghi Chú    =============== --%>
