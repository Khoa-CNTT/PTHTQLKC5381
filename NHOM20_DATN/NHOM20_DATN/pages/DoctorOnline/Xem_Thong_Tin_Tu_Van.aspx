<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/DoctorOnline_MasterPage.Master" AutoEventWireup="true" CodeBehind="Xem_Thong_Tin_Tu_Van.aspx.cs" Inherits="NHOM20_DATN.pages.DoctorOnline.Xem_Thong_Tin_Tu_Van" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <style>
     ...
     .table-title {
         ...
         margin-bottom: 20px;
         color: #ffffff;
         background: linear-gradient(to right, #317e91, #4aa1b5);
         padding: 15px;
         font-style: italic;
         border-radius:5px;
     }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <h2 class="table-title">Xem Thông Tin Tư Vấn</h2>
    <div class="Phankhung">
